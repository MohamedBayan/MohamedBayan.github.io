...
(function () {
  ...
  const FR = {
    ...
    "stat.pubs": "Articles évalués par les pairs",
    ...
    "news.d3": "2026",
    "news.t3": "<b>MemeLens</b> a été accepté dans les Findings of ACL 2026.",
    "news.d4": "2026",
    ...
    "proj.arhate": "Jeux de données de discours haineux en arabe et ressources de mèmes multimodales pour la recherche en modération de contenu en arabe.",
    "proj.memeagent": "Un agent vision-langage augmenté d'outils, entraîné avec GRPO, qui raisonne sur les mèmes et appelle des outils externes pour détecter les contenus nuisibles.",
    "proj.grpo": "Un système d'apprentissage par renforcement associant GRPO à une supervision par chaîne de pensée pour une détection explicable des mèmes haineux et propagandistes.",
    "proj.llamalens": "Un LLM multilingue spécialisé avec des jeux de données d'instructions en arabe, anglais et hindi pour l'analyse de l'actualité et des réseaux sociaux.",
    "proj.memeintel": "Analyse multimodale explicable des mèmes : jeux de données d'instructions, le modèle MemeLens-VLM et un banc d'essai multilingue.",
  ...
  const DE = {
    ...
    "stat.pubs": "Begutachtete Veröffentlichungen",
    ...
    "news.d3": "2026",
    "news.t3": "<b>MemeLens</b> wurde für die Findings of ACL 2026 angenommen.",
    "news.d4": "2026",
    ...
    "proj.arhate": "Arabische Hassrede-Datensätze und multimodale Meme-Ressourcen für die Inhaltsmoderationsforschung im Arabischen.",
    "proj.memeagent": "Ein werkzeuggestützter Vision-Sprach-Agent, trainiert mit GRPO, der über Memes schlussfolgert und externe Werkzeuge aufruft, um schädliche Inhalte zu erkennen.",
    "proj.grpo": "Ein RL-System, das GRPO mit Chain-of-Thought-Supervision kombiniert, um hetzerische und propagandistische Memes erklärbar zu erkennen.",
    "proj.llamalens": "Ein spezialisiertes mehrsprachiges LLM mit Instruktionsdatensätzen in Arabisch, Englisch und Hindi für die Nachrichten- und Social-Media-Analyse.",
    "proj.memeintel": "Erklärbare multimodale Meme-Analyse: Instruktionsdatensätze, das Modell MemeLens-VLM und ein mehrsprachiger Benchmark.",
    "proj.llmebench": "Mitwirkender am Benchmarking-Framework des QCRI zur Bewertung von LLMs über viele Aufgaben und Sprachen hinweg.",
  ...
  const NL = {
    ...
    "stat.pubs": "Peer-reviewed publicaties",
    ...
    "news.d3": "2026",
    "news.t3": "<b>MemeLens</b> is geaccepteerd voor de Findings of ACL 2026.",
    "news.d4": "2026",
    ...
    "proj.arhate": "Arabische datasets met haatzaaiende taal en multimodale meme-bronnen voor onderzoek naar contentmoderatie in het Arabisch.",
    "proj.memeagent": "Een tool-versterkte vision-taalagent, getraind met GRPO, die over memes redeneert en externe tools aanroept om schadelijke inhoud te detecteren.",
    "proj.grpo": "Een RL-systeem dat GRPO combineert met chain-of-thought-supervisie voor verklaarbare detectie van haatdragende en propagandistische memes.",
    "proj.llamalens": "Een gespecialiseerd meertalig LLM met instructiedatasets in het Arabisch, Engels en Hindi voor nieuws- en socialemedia-analyse.",
    "proj.memeintel": "Verklaarbare multimodale meme-analyse: instructiedatasets, het MemeLens-VLM-model en een meertalige benchmark.",
    "proj.llmebench": "Bijdrager aan QCRI's benchmarkframework voor het evalueren van LLM's over veel taken en talen.",
    "contact.title": "Contact",
